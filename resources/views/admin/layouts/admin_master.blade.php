...
<html lang="en">
  <head>
    ...
    <title>TGR | Admin</title>    <!-- CSS files -->
    <link href="/backend/dist/css/tabler.min.css?1692870487" rel="stylesheet"/>
    <link href="/backend/dist/css/tabler-flags.min.css?1692870487" rel="stylesheet"/>
    <link href="/backend/dist/css/tabler-payments.min.css?1692870487" rel="stylesheet"/>
    <link href="/backend/dist/css/tabler-vendors.min.css?1692870487" rel="stylesheet"/>
    <link href="/backend/dist/css/demo.min.css?1692870487" rel="stylesheet"/>
    <style>
      ...
      <aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="white">
        <div class="container-fluid">
          ...
          <h1 class="navbar-brand navbar-brand-autodark">
            <a href=".">
              <img src="backend/logo.png" width="110" height="32" alt="Tabler" class="navbar-brand-image">
            </a>
          </h1>
              ...
              <ul class="navbar-nav">
                <li class="nav-item active dropdown">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item active" href="{{ route('contactapp') }}">
                          Contact App
                          <span class="badge custom-badge ms-auto">1</span>
                        </a>
                        <a class="dropdown-item" href="{{ route('notesapp') }}">
                          Note App
                          <span class="badge custom-badge ms-auto">2</span>
                        </a>
