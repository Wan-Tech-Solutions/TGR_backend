          ...
          <div class="container-xl">
            ...
            <div class="card">
              <div class="row g-0">
                ...
                <div class="col-12 col-lg-3 col-xl-2 border-end">
                  <div class="card-header d-none d-md-block">
                    <div class="input-icon">
                      <button type="button" class="btn btn-primary m-3" data-bs-toggle="modal" data-bs-target="#composeModal">
                        Compose
                      </button>
                    </div>
                  </div>
                            ...
                            <div class="modal-body">
                              <form>
                                ...
                                <div class="mb-3">
                                  ...
                                  <input type="email" class="form-control" id="recipients" placeholder="Enter recipient emails" multiple>
                                </div>
                                ...
                                <div class="mb-3">
                                  ...
                                  <a href="https://www.icloud.com/" target="_blank" class="btn btn-outline-info">
                                    <i class="bi bi-cloud"></i> iCloud
                                  </a>
