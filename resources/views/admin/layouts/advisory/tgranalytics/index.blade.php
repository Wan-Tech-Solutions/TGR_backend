                    ...
                    <div id="datatable-default_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped mb-0 dataTable no-footer"
                                ...
                                <tbody>
                                    @foreach ($tgranalytics as $key => $list)
                                        <tr role="row" class="odd">
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $list->title }}</td>
                                            <td>{{ $list->first_para_analytic }}</td>
                                            {{-- <td>{{ $list->second_para_analytic }}</td> --}}
                                            <td>
                                                <ul>
                                            ...
                                            <td>{{ $list->analytic_process }}</td>
                                            <td>
                                                <a class="btn btn-primary btn-sm"
                                                    href="{{ route('site-edit-tgranalytic', ['uuid' => $list->uuid]) }}"><i
                                                        class="fas fa-pencil-alt"></i></a>
                                                <a class="btn btn-danger btn-sm"
                                                    href="{{ route('site-delete-tgranalytic', $list->uuid) }}"
