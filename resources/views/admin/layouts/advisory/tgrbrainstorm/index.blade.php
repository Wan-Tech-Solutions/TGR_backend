                    ...
                    <div id="datatable-default_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped mb-0 dataTable no-footer"
                                ...
                                <tbody>
                                    @foreach ($brainstorm as $key => $list)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>{{ $list->brainstorm_process }}</td>
                                            <td>
                                                <a class="btn btn-primary btn-sm"
                                                    href="{{ route('site-edit-tgrbrainstorm', ['uuid' => $list->uuid]) }}"><i
                                                        class="fas fa-pencil-alt"></i></a>
                                                <a class="btn btn-danger btn-sm"
                                                    href="{{ route('site-delete-tgrbrainstorm', $list->uuid) }}"
