...
!(function () {
    ...
    (i.d = function (e, t) {
        ...
        (function () {
            ...
            function j(e) {
                return (
                    e instanceof C(e).HTMLElement || e instanceof HTMLElement
                );
            }
            function T(e) {
                return (
            ...
            function W(e, t, i) {
                ...
                t &&
                    j(e) &&
                    ((n =
                        (e.offsetWidth > 0 && F(s.width) / e.offsetWidth) || 1),
                    (o =
                        (e.offsetHeight > 0 && F(s.height) / e.offsetHeight) ||
                        1));
            ...
            function Y(e) {
                for (
                    var t = C(e), i = V(e);
                    i && B(i) && "static" === z(i).position;

                )
                    i = V(i);
                return i &&
                    ("html" === S(i) ||
                        ("body" === S(i) && "static" === z(i).position))
                    ? t
                    : i ||
                          (function (e) {
            ...
            function pe(e, t) {
                ...
                var s = ue(e),
                    ...
                    o = C(s),
                    r = n
                        ? [o].concat(o.visualViewport || [], he(s) ? s : [])
                        : s,
                    a = t.concat(r);
            ...
            function _e(e, t) {
                ...
                var i = t,
                    ...
                    D = (function (e, t, i, s) {
                        ...
                        O(T) ? T : T.contextElement || R(e.elements.popper),
                        g,
                        b,
                        d
                    ),
                            ...
                            if (d) {
                                var I,
                                    ...
                                    oe = k
                                        ...
                                        : K + se + ie + T.mainAxis,
                                    re =
                                        t.elements.arrow && Y(t.elements.arrow),
                                    ae = re
                                        ? "y" === A
                                            ? re.clientTop || 0
                                            : re.clientLeft || 0
                    ...
                    var n,
                        ...
                        d = {
                            ...
                            setOptions: function (i) {
                                var n =
                                    "function" == typeof i ? i(a.options) : i;
                                h(),
            ...
            var je = Oe(),
                Te = Oe({
                    defaultModifiers: [ne, xe, ie, D, Ee, be, ke, G, we],
                }),
            ...
            const Pe = new Map(),
                ...
                Ke = (e, t, i = !0) => {
                    ...
                    const o = ({ target: i }) => {
                        i === t &&
                            ((n = !0), t.removeEventListener(Me, o), Ue(e));
                    };
            ...
            function dt(e, t, i, s, n) {
                const o = at(t[i], s, n);
                o &&
                    (e.removeEventListener(i, o, Boolean(n)),
            ...
            function ht(e, t, i, s) {
                ...
                for (const [o, r] of Object.entries(n))
                    o.includes(s) &&
                        dt(e, t, i, r.callable, r.delegationSelector);
            }
            function ut(e) {
                    ...
                    pt.on(
                        ...
                        function (i) {
                            if (
                                ...
                                return;
                            const n =
                                wt.getElementFromSelector(this) ||
                                this.closest(`.${s}`);
            ...
            class ri extends vt {
                ...
                _addTouchEventListeners() {
                    for (const e of wt.find(
                        ...
                        pt.on(e, Ut, (e) => e.preventDefault());
                    const e = {
                        leftCallback: () =>
                            this._slide(this._directionToOrder(zt)),
                        rightCallback: () =>
                            this._slide(this._directionToOrder(Bt)),
                        endCallback: () => {
                            "hover" === this._config.pause &&
                                (this.pause(),
                                this.touchTimeout &&
                ...
                _directionToOrder(e) {
                    return Ye() ? (e === zt ? Ht : $t) : e === zt ? $t : Ht;
                }
                _orderToDirection(e) {
                    return Ye() ? (e === Ht ? zt : Bt) : e === Ht ? Bt : zt;
                }
                static jQueryInterface(e) {
                    return this.each(function () {
                    ...
                    if (
                        (this._config.parent &&
                            (e = this._getFirstLevelChildren(
                                ...
                                .map((e) =>
                                    yi.getOrCreateInstance(e, { toggle: !1 })
                                )),
            ...
            const wi = "dropdown",
                ...
                qi = Ye() ? "top-start" : "top-end",
                Wi = Ye() ? "bottom-end" : "bottom-start",
                $i = Ye() ? "bottom-start" : "bottom-end",
                Hi = Ye() ? "left-start" : "right-start",
                zi = Ye() ? "right-start" : "left-start",
                Bi = {
                    autoClose: !0,
            ...
            class Qi extends vt {
                ...
                _completeHide(e) {
                    if (!pt.trigger(this._element, Li, e).defaultPrevented) {
            ...
            class ns extends bt {
                ...
                deactivate() {
                    this._isActive &&
                        ((this._isActive = !1), pt.off(document, Gi));
                }
                _handleFocusin(e) {
            ...
            class Ls extends vt {
                ...
                static jQueryInterface(e, t) {
                    return this.each(function () {
                        const i = Ls.getOrCreateInstance(this, e);
                        if ("string" == typeof e) {
                            if (void 0 === i[e])
                                throw new TypeError(`No method named "${e}"`);
                            i[e](t);
            ...
            pt.on(document, ys, '[data-bs-toggle="modal"]', function (e) {
                ...
                i && Ls.getInstance(i).hide(),
                    Ls.getOrCreateInstance(t).toggle(this);
            }),
                Et(Ls),
                Xe(Ls);
            const Ss = ".bs.offcanvas",
                Cs = ".data-api",
                Os = `load${Ss}${Cs}`,
                js = "show",
                Ts = "showing",
                ...
                Ws = `resize${Ss}`,
                $s = `click${Ss}${Cs}`,
                Hs = `keydown.dismiss${Ss}`,
                zs = { backdrop: !0, keyboard: !0, scroll: !1 },
                Bs = {
                    backdrop: "(boolean|string)",
                    keyboard: "boolean",
                    scroll: "boolean",
            ...
            pt.on(document, $s, '[data-bs-toggle="offcanvas"]', function (e) {
                ...
                pt.on(window, Os, () => {
                    for (const e of wt.find(Ps))
                        Rs.getOrCreateInstance(e).show();
                }),
                pt.on(window, Ws, () => {
                    for (const e of wt.find(
                        ...
                        ? (function (e, t, i) {
                              ...
                              for (const e of n) {
                                  ...
                                  const s = [].concat(...e.attributes),
                                      n = [].concat(t["*"] || [], t[i] || []);
                                  for (const t of s)
                                      Xs(t, n) || e.removeAttribute(t.nodeName);
                              }
            ...
            class dn extends vt {
                ...
                _createPopper(e) {
                    const t = Ue(this._config.placement, [
                            this,
                            e,
                            this._element,
                        ]),
            ...
            const An = ".bs.tab",
                ...
                Vn = `.${Wn}[data-bs-toggle="tab"], .${Wn}[data-bs-toggle="pill"], .${Wn}[data-bs-toggle="list"]`;
            class Yn extends vt {
                constructor(e) {
                    super(e),
                ...
                show() {
                    ...
                    const t = this._getActiveElem(),
                        i = t ? pt.trigger(t, Ln, { relatedTarget: e }) : null;
                            ...
                            () => {
                                "tab" === e.getAttribute("role")
                                    ? (e.setAttribute("aria-selected", !1),
                                      ...
                                      pt.trigger(e, Sn, { relatedTarget: t }))
                ...
                _keydown(e) {
                    if (![Pn, Nn, Mn, Fn, In, qn].includes(e.key)) return;
                    e.stopPropagation(), e.preventDefault();
                    const t = this._getChildren().filter((e) => !He(e));
                    let i;
                    if ([In, qn].includes(e.key))
            ...
            pt.on(document, jn, Rn, function (e) {
                ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
                    He(this) || Yn.getOrCreateInstance(this).show();
            }),
                pt.on(window, Dn, () => {
            ...
            class lo extends vt {
                ...
                _setListeners() {
                    pt.on(this._element, Un, (e) => this._onInteraction(e, !0)),
                        pt.on(this._element, Kn, (e) =>
                            this._onInteraction(e, !1)
                        ),
                        pt.on(this._element, Zn, (e) =>
                            this._onInteraction(e, !0)
                        ),
                        pt.on(this._element, Gn, (e) =>
                            this._onInteraction(e, !1)
                        );
                }
                _clearTimeout() {
                    ...
                    function e(t, i) {
                        ...
                        if (
                            ...
                            (this._onStopScrolling = function () {
                                Ko(s.el, s.classNames.scrolling),
                                    s.options.autoHide &&
                                        (s.hideScrollbar("x"),
                                        s.hideScrollbar("y")),
                                    (s.isScrolling = !1);
                    ...
                    return (
                            ...
                            (this.wrapperEl = this.el.querySelector(
                                ...
                                (this.contentWrapperEl =
                                    ...
                                    this.el.querySelector(
                                        Zo(this.classNames.contentWrapper)
                                    )),
                                (this.contentEl =
                                    this.options.contentNode ||
                                    this.el.querySelector(
                                        Zo(this.classNames.contentEl)
                                    )),
                                (this.offsetEl = this.el.querySelector(
                                    Zo(this.classNames.offset)
                                )),
                                (this.maskEl = this.el.querySelector(
                                    Zo(this.classNames.mask)
                                )),
                                ...
                                (this.axis.x.scrollbar.el =
                                    (null === (e = this.axis.x.track.el) ||
                                    void 0 === e
                                        ? void 0
                                        : e.querySelector(
                                              Zo(this.classNames.scrollbar)
                                          )) || null),
                                (this.axis.y.scrollbar.el =
                                    (null === (t = this.axis.y.track.el) ||
                                    void 0 === t
                                        ? void 0
                                        : t.querySelector(
                                              Zo(this.classNames.scrollbar)
                                ...
                                var t = this.contentEl.offsetWidth,
                                    i =
                                        this.heightAutoObserverEl
                                            .offsetHeight <= 1,
                                    s =
                                        this.heightAutoObserverEl.offsetWidth <=
                                            1 || t > 0,
                        ...
                        (e.prototype.onMouseMoveForAxis = function (e) {
                            ...
                            t.track.el &&
                                t.scrollbar.el &&
                                ((t.track.rect =
                                    t.track.el.getBoundingClientRect()),
                                (t.scrollbar.rect =
                        ...
                        (e.prototype.onDragStart = function (e, t) {
                            ...
                            (this.axis[t].dragOffset =
                                ...
                                (this.draggedAxis = t),
                                Uo(this.el, this.classNames.dragging),
                ...
                sr = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.unMount = function () {
                            Go.prototype.unMount.call(this),
            ...
            class rr {
                        ...
                        (e) => (
                            ...
                            new bootstrap.Tooltip(e, {
                                ...
                                animation: !(
                                    ...
                                    "true" !=
                                        e.dataset.bsAnimation.toLowerCase()
                                ),
                            })
                        )
                    );
                ...
                static jsFlatpickr() {
                    document
                        ...
                        .forEach((e) => {
                            e.classList.add("js-flatpickr-enabled"),
                                flatpickr(e);
                        });
                }
                static jqAppear() {
                    ...
                    jQuery.isEmptyObject(e)
                        ...
                        : jQuery.notify(
                              ...
                              },
                              {
                                  ...
                                  animate: {
                                      enter:
                                          e.animate_enter || "animated fadeIn",
                                      exit:
                                          e.animate_exit ||
                                    ...
                                    line: () => {
                                        (o.type = n),
                                            ...
                                            (o.spotColor =
                                                ...
                                                "#495057"),
                                            (o.minSpotColor =
                                                s.data("min-spot-color") ||
                                                "#495057"),
                                            (o.maxSpotColor =
                                                s.data("max-spot-color") ||
                                                "#495057"),
                                    ...
                                    tristate: () => {
                                        (o.type = n),
                                            ...
                                            (o.barSpacing =
                                                s.data("bar-spacing") || 6),
                                            (o.posBarColor =
                                                s.data("pos-bar-color") ||
                                                "#82b54b"),
                                            (o.negBarColor =
                                                s.data("neg-bar-color") ||
                                                "#e04f1a");
                                    },
                                };
                            r[n]
                    ...
                    (t._lSidebar || t._lSideOverlay) &&
                        ("init" === e
                            ...
                            : (e = "custom-scroll") &&
                              ...
                              (t._lSidebar &&
                                  !t._lSidebarScroll &&
                                  (t._lSidebarScroll = new sr(
                                      t._lSidebarScrollCon
                                  )),
                              t._lSideOverlay &&
                                  !t._lSideOverlayScroll &&
                                  (t._lSideOverlayScroll = new sr(
                                      t._lSideOverlay
                                  ))));
                }
                _uiHandleHeader() {
            ...
            window.Dashmix = new (class extends ar {
                constructor() {
                    super();
                }
            })();
